...
# Arg2: script
run_script_as() {
  echo -e "\033[41m[TARGET/MAIN.SH] Run $2 as $1\033[0m"
  sudo -H -u $1 bash -c "cd ~ && bash" < $2
}

# Wait for internet connection
echo -e "\033[41m[TARGET/MAIN.SH] Waiting for internet connection...\033[0m"
bash ./connect.sh

# Add additional repos and update
echo -e "\033[41m[TARGET/MAIN.SH] Apt update & upgrade\033[0m"
...
echo -e "\033[41m[TARGET/MAIN.SH] Remove auto-start of this file\033[0m"
...
echo -e "\033[41m[TARGET/MAIN.SH] Installing apt packages\033[0m"
export DEBIAN_FRONTEND=noninteractive
...
echo -e "\033[41m[TARGET/MAIN.SH] Moving fos files into user workspace\033[0m"
...
echo -e "\033[41m[TARGET/MAIN.SH] Setting wallpaper\033[0m"
mv $INSTALLER_DIR/wallpaper.png /usr/share/backgrounds
chown -R $USER_NAME:$USER_NAME /usr/share/backgrounds

# Install modules
echo -e "\033[41m[TARGET/MAIN.SH] Installing modules\033[0m"
...
echo -e "\033[41m[TARGET/MAIN.SH] Removing nvidia and ubuntu users\033[0m"
sudo userdel -rfRZ nvidia
sudo userdel -rfRZ ubuntu

# Clean up
echo -e "\033[41m[TARGET/MAIN.SH] CLeaning up install files\033[0m"
