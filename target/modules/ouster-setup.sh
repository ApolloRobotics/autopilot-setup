...
echo -e "\033[41m[TARGET/OUSTER-SETUP.SH] Installing aliases\n\033[0m"
...
echo -e "\033[41m[TARGET/OUSTER-SETUP.SH] Adding LiDAR as a network device\n\033[0m"
sudo nmcli con add type ethernet con-name lidar ifname eth0 ip4 192.168.2.1/24

# Configure dnsmasq
echo -e "\033[41m[TARGET/OUSTER-SETUP.SH] Configuring dnsmasq\n\033[0m"
...
echo -e "\033[41m[TARGET/OUSTER-SETUP.SH] Adding hostname to bashrc\n\033[0m"
echo '
save_os1_hostname() { 
