...
# Clone Ouster repo
echo -e "\033[41m[TARGET/OUSTER-SETUP.SH] Downloading files\033[0m"
git clone https://github.com/ouster-lidar/ouster_example.git $HOME/workspace/ouster_example

# Setup ROS independant projects
echo -e "\033[41m[TARGET/OUSTER-SETUP.SH] Setting up ouster_client\033[0m"
cd $HOME/workspace/ouster_example/ouster_client && mkdir build && cd build && cmake .. && make
echo -e "\033[41m[TARGET/OUSTER-SETUP.SH] Setting up ouster_viz\033[0m"
cd $HOME/workspace/ouster_example/ouster_viz && mkdir build && cd build && cmake .. && make

# Install ROS Sample
echo -e "\033[41m[TARGET/OUSTER-SETUP.SH] Setting up catkin and ouster_example\033[0m"
...
echo -e "\033[41m[TARGET/OUSTER-SETUP.SH] Installing aliases\033[0m"
...
echo -e "\033[41m[TARGET/OUSTER-SETUP.SH] Adding LiDAR as a network device\033[0m"
sudo nmcli con add type ethernet con-name lidar ifname eth0 ip4 192.168.2.1/24

# Configure dnsmasq
echo -e "\033[41m[TARGET/OUSTER-SETUP.SH] Configuring dnsmasq\033[0m"
...
echo -e "\033[41m[TARGET/OUSTER-SETUP.SH] Adding hostname to bashrc\033[0m"
echo '
save_os1_hostname() { 
