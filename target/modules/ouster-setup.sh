...
echo "[TARGET/OUSTER-SETUP.SH] Installing aliases"
...
echo "[TARGET/OUSTER-SETUP.SH] Adding LiDAR as a network device"
sudo nmcli con add type ethernet con-name lidar ifname eth0 ip4 192.168.2.1/24

# Configure dnsmasq
echo "[TARGET/OUSTER-SETUP.SH] Configuring dnsmasq"
...
echo "[TARGET/OUSTER-SETUP.SH] Adding hostname to bashrc"
echo '
save_os1_hostname() { 
