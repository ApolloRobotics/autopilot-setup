...
# Install projects
echo -e "\033[41m[TARGET/AUTOPILOT-CORE-SETUP.SH] Installing service registry\033[0m"
cd $HOME/workspace/autopilot-core/fos-service-registry && npm install
echo -e "\033[41m[TARGET/AUTOPILOT-CORE-SETUP.SH] Installing api gateway\033[0m"
cd $HOME/workspace/autopilot-core/fos-gateway && npm install
echo -e "\033[41m[TARGET/AUTOPILOT-CORE-SETUP.SH] Installing status checks\033[0m"
cd $HOME/workspace/autopilot-core/fos-status-checks && npm install
echo -e "\033[41m[TARGET/AUTOPILOT-CORE-SETUP.SH] Installing flight stack\033[0m"
...
echo -e "\033[41m[TARGET/AUTOPILOT-CORE-SETUP.SH] Creating .env\033[0m"
echo "NODE_ENV=\"development\"
CLOUD_URI=\"http://api.flightservice.io\"
VEHICLE_TYPE=\"multirotor\"" > $HOME/.env

# Set up PM2
echo -e "\033[41m[TARGET/AUTOPILOT-CORE-SETUP.SH] Setting up PM2\033[0m"
